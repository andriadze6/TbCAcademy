    ...
    return(
        <div>
            <div className='BlogPage'>
                ...
                <h1>2. Statement Outerwear</h1>
                <p>Nothing says fall like a statement coat. This season, trench coats, tailored blazers, and oversized puffer jackets are making waves. Try bold prints like plaid or houndstooth to add flair to any outfit, or keep it classic with neutral tones like beige or camel.
                Trend Alert: Look for coats with unique detailing—think exaggerated lapels, cinched waists, or faux fur accents.</p>
            </div>
        </div>
    )
}
