...
export default function AddressFormMyAccount() {
  const { user } = useAuth();
  ...
  return (
      <div style={{display:"flex", gap:"20px"}}>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr", gap:"10px", marginTop:"20px"}}>
          <button className="add_new_address" onClick={() => setData(prev => ({ ...prev, showPopup: true, edit:false }))} style={{background:"transparent=", height:"250px", minWidth:"250px",cursor:"pointer"}}>
                  ...
                  <div>
                    <div className="address-Div" style={{display:"flex",flexDirection:"column", gap:"10px", padding:"10px"}}>
                        ...
                        <div style={{display:"flex", gap:"10px"}}>
                            ...
                            <div>
                                <p style={{paddingBottom:"5px"}}>{address.city}</p>
                                {
                                    address.region && <p>{address.region}</p>
                                }
                                <p style={{paddingBottom:"5px"}}>{address.street_Address}</p>
                                <p style={{paddingBottom:"5px"}}>{address.apartment_Number}</p>
                                <p style={{display:"flex",gap:"10px", paddingBottom:"5px", alignItems:"center"}}>{t("PostalCode")} :{address.zip_Code}</p>
                            </div>
                        </div>
